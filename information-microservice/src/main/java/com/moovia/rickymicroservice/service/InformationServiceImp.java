...
@Service
public class InformationServiceImp extends AbstractClient implements InformationService {

    public InformationServiceImp(RestTemplate restTemplate) {
        super(restTemplate);
    }

    @Override
    public ResponseEntity<?> getInformation(String card) {
        ResponseInfo responseInfo;
        String uri = baseUrl + "/getInformation/" + card;
